/*
   ...
   changes by Computacao na Escola - October 2014
   -------------------------------
   StageMorph.prototype.drawNew changed to allow video.
...
SpriteMorph.prototype.initBlocks = function () {
    SpriteMorph.prototype.blocks = {
        ...
        // Motion
/* ==================================================================
 * Cria Bloco forward 2 como copia do "move"
 * Bloco tem de ser instalado, mais abaixo.
 * Aldo 2014
 * ================================================================== */
  /*      forward2: {
            only: SpriteMorph,
...
/* ==================================================================
 * Inicializa Blocos
 * Changes by Aldo 2014
 * ================================================================== */
    if (cat === 'motion') {

        //blocks.push(block('forward2'));  // Meu bloco copiado de "Move"
...
/* ==================================================================
 * Inicializa Blocos na categoria sensing para Sprites/Atores
 * Added block manageVideo
 * Aldo 2014
 * ================================================================== */
 ...
 * implementing a behaviour for the (turn video on) and (turn video off) blocks.
 * 
 * Aldo 2014
 * ================================================================== */
...
SpriteMorph.prototype.pauseVideo = function () {
	if (this instanceof StageMorph) {
		...
		alert("Only the Stage can pause the Video!");
	}
};

SpriteMorph.prototype.playVideo = function () {
	if (this instanceof StageMorph) {
		this.webcam = 1;
		/* ========================================================================= 
		 *
...
/* ========================================================================
 * Define what block "forward2" does
 * Simply a copy of forward plus a message on the JS console
 * Aldo 2014
 * ======================================================================== */
 /* SpriteMorph.prototype.forward2 = function (steps) {
    var dest,
...
StageMorph.prototype.init = function (globals) {
	...
	// Define and initialize webcam instance variable for the StageMorph
	// videoOnCanvas Snap! Extension
	// Aldo 2014
	this.webcam = 0;
	// Creat an instance variable to hold a direct reference to the video.
	// This should be reprogrammed decently in the future treating the video as a child....
	this.video = 0; 
	...
	/* ========================================================================= *
	 ctx = this.image.getContext('2d');
	 console.log("*");
		myvideoOnCanvas = new videoOnCanvas(ctx, drawVideoOnCanvasFunction);
	/* ========================================================================= */
 ...
 * Changes:
 * - myvideoOnCanvas variable
 * - Assignemnt to function: 
 *      myvideoOnCanvas = new videoOnCanvas(this, drawVideoOnCanvasFunction)
 *
 * This method sends the current instance of StageMorph to the drawVideoOnCanvasFunction
 * because after each frame a call to <current StageMorph instance>.changed()
 * has to be performed in order to force the video frame to be drawn.
 * If you don't do this, video frames will only be drawn when the stage is 
 * updating itself in order to repair damages and you will be seeing a still
 * video picture most of the time.
 * ========================================================================= */
...
StageMorph.prototype.drawNew = function () {
	...
	if (this.webcam == 1) {
		...
		* The drawVideoOnCanvasFunction is implemented in videoOnCanvas.js
		*
		* This call is here in order to allow the StageMorph to reinstantiate the webcam
		* after it is totally redrawn e.g. after a resize of the Stage.
		*
		* videoOnCanvas Snap! Extension
		* Aldo 2014
		*                                                                           */
...
/* ==================================================================
 * StageMorph Video Management (videoOnCanvas Snap! Extension)
 * Creates the methods manageVideo and freeVideo for the class StageMorph
 * as a copy of the methods with the same name in class SpriteMorph
 * 
 * Aldo 2014
 * ================================================================== */
...
StageMorph.prototype.playVideo
    = SpriteMorph.prototype.playVideo;

StageMorph.prototype.freeVideo
    = SpriteMorph.prototype.freeVideo;
