...
function videoOnCanvas(morphContext, drawVideoFunction) {
  ...
  // var streamContainer = this.canvasContext.canvas; //document.createElement('div')
  ...
  // The video should fill out all of the canvas -> Nothing seems to work
  this.video.setAttribute('width', this.canvasContext.canvas.width+"px");
  this.video.setAttribute('height', this.canvasContext.canvas.height+"px");
  
  console.log("Width: " + this.canvasContext.canvas.width+"px");
  console.log("Height: " + this.canvasContext.canvas.height+"px");
  
  this.video.setAttribute('style', 'display:none');
  this.video.setAttribute('style', 'width:'+this.canvasContext.canvas.width+'px');
  this.video.setAttribute('style', 'height:'+this.canvasContext.canvas.height+'px');
  ...
  this.update = function() {
    ...
    var loop = function() {
	  ...
	  console.log("looping ...");
	  if (morphContext.webcam == 0) return;
    }
    requestAnimationFrame(loop);
